...
const cacheTimeMin    = msHour * 3;
const cacheTimeMax    = msHour * 4;
const cacheRefresh    = msHour * 1;
    ...
    */
    ...
    __refresh(guild) {
        ...
        if (isDueForRefresh) {
            ...
            async.nextTick(this.__getRemote.bind(this, remoteParams, progressKey, _.noop, _.noop));
        }
