    ...
    */
    ...
    __getRemote(params, key, fnInProgress, fnCallback) {
        ...
        if (this.inProgress[key]) {
            ...
            const requestOpts = {
                url: `https://api.guildwars2.com/v1/guild_details`,
                qs: params,
                gzip: true,
            };
            ...
            request(requestOpts, (err, response, body) => {
                ...
                const guildData = parseJSON(body, {});

                if (!err) {
                    if (response.statusCode !== 200) {
                        err = {status: response.statusCode};
                    }
                    else if(!_.has(guildData, 'guild_id')) {
                        err = {status: 404};
                    }
                }
                ...
                // console.log('__getRemote', params, response.toJSON());
                // console.log('__getRemote', params, response.statusCode);
