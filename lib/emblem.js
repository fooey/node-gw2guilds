...
function getColor(colorId) {
	// console.log(DB.colors.index);
	// console.log(DB.colors.index.toJS());

	const color = DB.colors.index.find(c => c.get('id') === colorId);
	const decRGB = color.getIn(['cloth', 'rgb']).toJS();
	console.log(color, colorId, decRGB);
